...
/*
Plugin Name: Paycorp Commercial Bank IPG
License URI: https://www.paycorp.com.au/
Description: Combank IPG by Paycorp.
Version: 1.0
...
/*
Paycorp Commercial Bank IPG is free software: you can redistribute it and/or modify
it under the terms of the GNU General Public License as published by
the Free Software Foundation, either version 2 of the License, or
any later version.
 
Paycorp Commercial Bank IPG is distributed in the hope that it will be useful,
but WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
GNU General Public License for more details.
 
You should have received a copy of the GNU General Public License
along with Paycorp Commercial Bank IPG. If not, see License URI: http://www.gnu.org/licenses/gpl-2.0.html.
*/
...
function woocommerce_combank_gateway()
{
    ...
    class WC_Combank extends WC_Payment_Gateway
    {
        public function __construct()
        {
            ...
            $this->id = 'combankipg';
            $this->method_title = 'Paycorp Combank IPG';
            $this->icon = apply_filters('woocommerce_Paysecure_icon', '' . $this->plugin_url . 'images/combank.jpg');
            ...
            add_action('init', array(&$this, 'check_combankIPG_response'));
        ...
        public function init_form_fields()
        {
            ...
            $this->form_fields = array(
                'enabled' => array(
                    ...
                    'type' => 'checkbox',
                    'label' => __('Enable Combank IPG Module.', 'paycorp'),
                    'default' => 'no'),
                ...
                'pg_domain' => array(
                    ...
                    'default' => __('https://combank.paycorp.com.au/rest/service/proxy', 'paycorp')),
        ...
        public function admin_options()
        {
            ...
            echo '<h3>' . __('Commercial Bank Paycorp Payment Gateway', 'paycorp') . '</h3>';
              // echo  content_url();
            $s =  content_url().'/plugins/paycorp_combank_ipg_demo/images/support.jpg';
            echo $s;
            ...
            echo '<a href="https://support.paycorp.com.au/" target="_blank"><img src="',$this->plugin_url,'images/support.jpg" alt="payment gateway" class="wpimage"  width="20%" height="15%"/></a>';
        ...
        //----------------------------------------
        function check_combankIPG_response()
        {
            global $wpdb;
            global $woocommerce;
    ...
    function woocommerce_add_combank_gateway($methods)
    {
        $methods[] = 'WC_Combank';
        return $methods;
    }

    add_filter('woocommerce_payment_gateways', 'woocommerce_add_combank_gateway');
